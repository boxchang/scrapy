...
from fugle_realtime.http_client.intraday import Intraday
...
class quote_api():
    ...
    def get_first_quote_data(self, symbol_id):
        config = {'api_token': '174047bf6e7c04d1006406339ca65eea', 'api_version': '0.3', 'url': 'https://api.fugle.tw/realtime/'}
        message = Intraday(config).quote(apiToken=self.api_token, symbolId=symbol_id, output='raw')
